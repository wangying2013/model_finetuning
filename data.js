...
const T=[
  ...
  {id:'ft-20260501-007',nm:'摘要生成精调',desc:'基于 Qwen3-8B 的摘要 SFT 全量精调',model:'Qwen3-8B',method:'SFT',mode:'全量参数',st:'pending',cr:'小红',tm:'2026-05-01 17:00',dur:'—',loss:null,progress:0,ep:3,lr:'1e-4',ds:'摘要SFT数据',dv:'Version4',gpu:'A100 × 2',stTm:'—',edTm:'—',outNm:'摘要生成精调',saveInt:200,expLim:5,resType:'公共资源',resPool:'',gpuModel:'A100',gpuC:2},
  {id:'ft-20260430-008',nm:'多轮对话优化-V2',desc:'基于 Qwen3-14B 的多轮对话 LoRA 精调',model:'Qwen3-14B',method:'SFT',mode:'LoRA',st:'completed',cr:'张三',tm:'2026-04-30 09:15',dur:'3h 20m',loss:0.041,progress:100,ep:4,lr:'1e-4',ds:'多轮对话数据集',dv:'Version2',gpu:'A100 × 2',stTm:'2026-04-30 09:15',edTm:'2026-04-30 04:35',outNm:'多轮对话优化-V2',saveInt:200,expLim:5,resType:'公共资源',resPool:'',gpuModel:'A100',gpuC:2},
  ...
  {id:'ft-20260424-014',nm:'简历解析微调',desc:'基于 Doubao-Lite 的简历解析 LoRA 精调',model:'Doubao-Lite-4K',method:'SFT',mode:'LoRA',st:'completed',cr:'张三',tm:'2026-04-24 09:30',dur:'0h 55m',loss:0.062,progress:100,ep:3,lr:'2e-4',ds:'简历解析数据集',dv:'Version2',gpu:'A100 × 1',stTm:'2026-04-24 09:30',edTm:'2026-04-24 02:25',outNm:'简历解析微调',saveInt:200,expLim:5,resType:'公共资源',resPool:'',gpuModel:'A100',gpuC:1},
  {id:'ft-20260423-015',nm:'邮件生成微调',desc:'基于 Qwen3-14B 的邮件生成 LoRA 精调',model:'Qwen3-14B',method:'SFT',mode:'LoRA',st:'pending',cr:'小明',tm:'2026-04-23 15:10',dur:'—',loss:null,progress:0,ep:3,lr:'1e-4',ds:'邮件生成训练集',dv:'Version1',gpu:'A100 × 2',stTm:'—',edTm:'—',outNm:'邮件生成微调',saveInt:200,expLim:5,resType:'公共资源',resPool:'',gpuModel:'A100',gpuC:2},
  {id:'ft-20260422-016',nm:'表格理解优化',desc:'基于 DeepSeek-R1-7B 的表格理解全量精调',model:'DeepSeek-R1-7B',method:'SFT',mode:'全量参数',st:'completed',cr:'小华',tm:'2026-04-22 10:00',dur:'4h 10m',loss:0.029,progress:100,ep:5,lr:'5e-5',ds:'表格理解数据集',dv:'Version3',gpu:'A100 × 4',stTm:'2026-04-22 10:00',edTm:'2026-04-22 06:10',outNm:'表格理解优化',saveInt:200,expLim:5,resType:'公共资源',resPool:'',gpuModel:'A100',gpuC:4},
  {id:'ft-20260421-017',nm:'用户画像生成',desc:'基于 Doubao-Pro 的用户画像 LoRA 精调',model:'Doubao-Pro-32K',method:'SFT',mode:'LoRA',st:'failed',cr:'李四',tm:'2026-04-21 14:30',dur:'0h 22m',loss:null,progress:22,ep:3,lr:'1e-4',ds:'用户画像数据集',dv:'Version2',gpu:'A100 × 1',stTm:'2026-04-21 14:30',edTm:'—',outNm:'用户画像生成',saveInt:200,expLim:5,resType:'公共资源',resPool:'',gpuModel:'A100',gpuC:1},
  ...
  {id:'ft-20260419-019',nm:'搜索排序精调-V3',desc:'基于 DeepSeek-R1-7B 的搜索排序 LoRA 精调',model:'DeepSeek-R1-7B',method:'SFT',mode:'LoRA',st:'completed',cr:'小红',tm:'2026-04-19 11:45',dur:'2h 30m',loss:0.051,progress:100,ep:4,lr:'1e-4',ds:'搜索排序训练集',dv:'Version3',gpu:'A100 × 2',stTm:'2026-04-19 11:45',edTm:'2026-04-19 06:15',outNm:'搜索排序精调-V3',saveInt:200,expLim:5,resType:'公共资源',resPool:'',gpuModel:'A100',gpuC:2},
  {id:'ft-20260418-020',nm:'报告摘要生成',desc:'基于 Qwen3-14B 的报告摘要 LoRA 精调',model:'Qwen3-14B',method:'SFT',mode:'LoRA',st:'pending',cr:'张三',tm:'2026-04-18 16:00',dur:'—',loss:null,progress:0,ep:3,lr:'1e-4',ds:'报告摘要数据集',dv:'Version2',gpu:'A100 × 2',stTm:'—',edTm:'—',outNm:'报告摘要生成',saveInt:200,expLim:5,resType:'公共资源',resPool:'',gpuModel:'A100',gpuC:2},
  {id:'ft-20260417-021',nm:'客服情绪识别',desc:'基于 Doubao-Lite 的情绪识别 LoRA 精调',model:'Doubao-Lite-4K',method:'SFT',mode:'LoRA',st:'completed',cr:'小明',tm:'2026-04-17 09:20',dur:'1h 10m',loss:0.073,progress:100,ep:3,lr:'2e-4',ds:'情绪识别数据集',dv:'Version1',gpu:'A100 × 1',stTm:'2026-04-17 09:20',edTm:'2026-04-17 02:30',outNm:'客服情绪识别',saveInt:200,expLim:5,resType:'公共资源',resPool:'',gpuModel:'A100',gpuC:1},
...
// Form state
const F={name:'',desc:'',method:'SFT',model:'',mode:'LoRA',ds:'',dv:'',lr:'1e-4',ep:3,bs:4,msl:2048,wr:0.03,wd:0.01,lrR:8,lrA:16,lrD:0.05,lrT:'q_proj,v_proj',outNm:'',expLim:5,saveInt:200,gpuT:'A100',gpuC:2,autoReg:true,resMode:'public',resPool:'pool-a',gpuModel:'A100',valMode:'none',valRatio:20,valDs:'',valDv:'',evalCount:10,advShown:false};
